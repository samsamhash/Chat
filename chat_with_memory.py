...
def build_rag_prompt(
    ...
    instructions = instructions or (
        "You are an expert assistant. Answer using ONLY the information in CONTEXT and MEMORY. "
        "If information is not sufficient, reply exactly: \"I do not have sufficient information in the documents.\" "
        "Cite sources using [doc_id#chunk_id] when possible."
    )
...
class ChatWithMemory:
    ...
    def ask(self, question: str, ui_history: Optional[List[Dict[str, str]]] = None, top_k: Optional[int] = None) -> str:
        ...
        prompt = LANGUAGE_GUARD + rag_prompt
